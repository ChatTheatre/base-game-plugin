...
//-----Component Setup
	...
	function initTheatre() {
        /* 1. REPLACE WITH YOUR GAME URL AND 2. GAME LOGO URL */
	...
	function updateCompass(bitfield, image, dir, bit) {
		...
		if (bitfield & bit) {
            /* 3. REPLACE WITH YOUR ARROW IMAGE DIRECTORY */
  	    	/* image.style.backgroundImage = "url(http://images.gables.chattheatre.com/arrows/" + dir + "-ex.gif)"; */
		} else {
            /* REPLACE WITH YOUR ARROW IMAGE DIRECTORY */
	    	/* 4. image.style.backgroundImage = "url(http://images.gables.chattheatre.com/arrows/" + dir + "-noex.gif)"; */
		}
    }
//-----Component Functionality
	...
	function popupMapWindow() {
			popupArtWin(bigMapHREF, 'Map', 'Chat Theatre Overview Map');
	}
